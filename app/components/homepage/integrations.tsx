        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32 lg:py-48">
          <div className="text-center space-y-10">            {/* Badge */}
            <div className="flex justify-center">
              <Badge variant="secondary" className="px-3 py-1.5 text-xs sm:text-sm font-medium bg-red-50 text-red-700 border-red-200 dark:bg-red-950 dark:text-red-300 dark:border-red-800">
                <Youtube className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                <span className="hidden sm:inline">#1 AI Script Writer for YouTube Creators</span>
                <span className="sm:hidden">#1 AI Script Writer</span>
              </Badge>
            </div>
